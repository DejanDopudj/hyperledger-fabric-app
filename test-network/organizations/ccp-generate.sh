...
P0PORT=9051
CAPORT=9055
PEERPEM=organizations/peerOrganizations/org3.example.com/tlsca/tlsca.org1.example.com-cert.pem
CAPEM=organizations/peerOrganizations/org3.example.com/ca/ca.org1.example.com-cert.pem
